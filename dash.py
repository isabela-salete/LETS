...
st.write("""O Observatório de Engenharia do Trabalho e Sustentabilidade é uma ferramenta de geração e disseminação de informações estratégicas sobre trabalho, emprego, renda e relações do trabalho da Região do Médio Paraíba - RJ. A geração e disseminação de informações sobre trabalho, emprego e renda preconiza que a integração de atuação das secretarias que formam o Ministério do Trabalho e Emprego demanda maior integração das políticas públicas. É fundamental o acesso a essas informações por parte dos trabalhadores (do setor formal e informal), empregadores e entidades sindicais, centrais sindicais, etc. O Observatório auxilia a comunidade científica, empresas, entidades e órgãos municipais e regionais que passam a ter acesso a informações com facilidade e confiabilidade para pesquisa. Outro impacto é o fluxo público de informações para tomada de decisões baseadas em evidências e orientadas para resultados que beneficiam a sociedade civil em geral. O projeto está alinhado com a Prioridade Neoindustrialização, Trabalho, Emprego e Renda – Plano Plurianual 2024-2027, com o programa 2310 – Promoção do Trabalho Decente, Emprego e Renda, com foco em promover e garantir segurança e saúde no trabalho, diálogo social, inclusão, acessibilidade e equidade no mundo do trabalho. Além disso, as suas ações possuem relação com os Objetivos de Desenvolvimento Sustentável da Agenda 2030.""")
